...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        navtb = QToolBar("Naviga")
        navtb.setIconSize(QSize(16, 16))
        self.addToolBar(navtb)

        # ADD BUTTONS TO NAVIGATION TOOLBAR
        # PREVIOUS WEB PAGE BUTTON
        back_btn = QAction(QIcon(os.path.join('icone', 'indietro')), "indietro", self)
        back_btn.setStatusTip("torna indietro")
        ...
        next_btn = QAction(QIcon(os.path.join('icone', 'Avanti')), "Forward", self)
        next_btn.setStatusTip("Avanti")
        ...
        reload_btn = QAction(QIcon(os.path.join('icone', 'Reload')), "Reload", self)
        reload_btn.setStatusTip("Ricarica la pagina page")
        ...
        # HOME PAGE BUTTON
        home_btn = QAction(QIcon(os.path.join('icone', 'Home')), "Home", self)
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("https://www.google.it/"))
...
# APPLICATION NAME
app.setApplicationName("Moder Browser")
# APPLICATION COMPANY NAME
app.setOrganizationName("Moder Company")
# APPLICATION COMPANY ORGANISATION
app.setOrganizationDomain("Moder.org")
